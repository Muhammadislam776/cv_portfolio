document.addEventListener("DOMContentLoaded", function () {
  ...
  // Mobile navbar drawer behavior
  const navbarCollapse = document.getElementById('navbarNav');
  const navbarBackdrop = document.getElementById('navbarBackdrop');
  if (navbarCollapse && navbarBackdrop && window.bootstrap) {
    ...
    // Remove the class at hide-start so the slide-out animation can run
    ...
    const drawerCloseBtn = navbarCollapse.querySelector('.drawer-close');
    if (drawerCloseBtn) {
